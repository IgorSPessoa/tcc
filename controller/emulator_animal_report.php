...
$query = $mysql->prepare(" INSERT INTO animal_report (author_name, author_phone, animal_situation, animal_description, animal_photo, localization_lastview, localization_observation, localization_photo) 
