            ...
            <?php
                ...
                <form action="controller/updateAdocao.php" method="POST" enctype="multipart/form-data" runat="server" novalidate> 
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-3">
                            <label for="animal_status" class="text-md "><h4>Estado da adoção:</h4></label>
                            <select class="form-control" id="animal_status" name="animal_status">
                                <option value="waiting" <?php if($situacao == "waiting") { echo "selected";} ?>>Aguardando</option>
                                <option value="scheduled" <?php if($situacao == "scheduled") { echo "selected";} ?>>Agendado</option>
                                <option value="adopted" <?php if($situacao == "adopted") { echo "selected";} ?>>Adotado</option>
                            </select>                           
                        </div>
                    </div>
                    ...
                    <div class="row mb-4">
                        ...
                        <div class="col-md-3 mb-3">
                            <label for="animal_category" class="text-md"><h4>Porte:</h4></label>
                            <select class="form-control" id="animal_category" name="animal_category" >
                                <option value="small" <?php if($categoria == "small") { echo "selected";} ?>>Pequeno</option>
                                <option value="average" <?php if($categoria == "average") { echo "selected";} ?>>Médio</option>
                                <option value="big" <?php if($categoria == "big") { echo "selected";} ?>>Grande</option>
                            </select>
                        </div>

                        <div class="col-md-3">
                            <label for="animal_gender" class="text-md"><h4>Sexo</h4></label>
                            <select class="form-control" id="animal_gender" name="animal_gender" value='<?php echo $sexo; ?>'>
                                <option value="male" <?php if($sexo == "male") { echo "selected";} ?>>Macho</option>
                                <option value="female" <?php if($sexo == "female") { echo "selected";} ?>>Fêmea </option>
                            </select>                            
                        </div>
                    </div>
                    ...
                    <div class="row mb-4">
                        <div class="col-md-4 mb-3">
                            <label for="animal_type" class="text-md"><h4>Animal:</h4></label>
                            <select class="form-control" id="animal_type" name="animal_type">
                                <option value="dog" <?php if($animal == "dog") { echo "selected";} ?>>Cachorro</option>
                                <option value="cat" <?php if($animal == "cat") { echo "selected";} ?>>Gato</option>
                                <option value="others" <?php if($animal == "others") { echo "selected";} ?>>Outros</option>
                            </select>                           
                        </div>
                        ...
                        <div class="col-md-4 mb-3">
                            <label for="animal_ong_since" class="text-md"><h4>Na Ong Desde:</h4></label>
