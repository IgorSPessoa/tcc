...
<body>
    ...
    <?php 
        ...
        if(isset($_GET['msg'])) { //Verificando se existe mensagem
            ...
            if ($msg == "sucess_adoption") { //verificando se ela deu certo, mandando a mensagem de sucesso
                include '../includes/modal.php';
            } elseif($msg == "sucess_updateAdoption"){//verificando se a a mensagem de sucesso ao vincular foi chamada, 
                include '../includes/modal.php';
            } elseif ($msg == "error_adoption") { //verificando se a a mensagem de error ao criar adoção foi chamada, 
                include '../includes/modal.php';
